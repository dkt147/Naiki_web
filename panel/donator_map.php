...
<?php
					...
					$query = "SELECT donate.d_id,register.r_id, register.al, register.lt, register.utype
					FROM donate
					INNER JOIN register ON donate.r_id=register.r_id where utype='donor'";
                      ...
                      $res = mysqli_query($conn, $query);
                                            ...
                                            if (mysqli_num_rows($res) > 0) {
                                                while ($row = mysqli_fetch_assoc($res)) {
                                                  ?>
L.marker([<?php echo $row['lt']?>,<?php echo $row['al']?>])
.addTo(map)
<?php
                                                }
                                            }
